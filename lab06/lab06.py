    ...
    def report(self):
        ...
        if self.changed():
            ...
            if self.difference < 0:
                ...
                status = "increased "
            msg = status + str(self.before) + "->" + str(self.after)
        else:
            msg = "no change"
...
class BankAccount:
    ...
    def __init__(self, account_holder):
        ...
        self.index = 0
        self.transactions = []   #为交易创建空列表用于存储
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.index,self.balance - amount,self.balance))
        self.index += 1
        return self.balance
