...
class VendingMachine:    #这个售货机的逻辑有些逆天  我一开始不太理解
    ...
    def __init__(self, product, price):
        ...
        self.stock = 0
        self.funds = 0
        self.temp = 0     #中间变量 用于存储清零之前的funds
    ...
    def vend(self):
        ...
        if self.stock == 0:
            ...
            self.temp = self.funds - self.price
            self.funds = 0
            self.stock -= 1
            return f"Here is your {self.product} and ${self.temp} change."
        elif self.funds < self.price:
...
def two_list(vals, counts):
    ...
    "*** YOUR CODE HERE ***"
    head = Link.empty
    for num,rep in zip(reversed(vals),reversed(counts)):
        for _ in range(rep):
            head = Link(num,head)
    return head
